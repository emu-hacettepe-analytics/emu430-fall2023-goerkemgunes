...
```
For the top 5 movies I watched CM101MMXI Fundamentals and I probably haven't watched both Hababam Sınıfı movies completely. To be honest, in my opinion, these movies, which are quite good for their time, do not entirely deserve these ratings and rankings.
For the bottom 5 movies I can't say, I watched them so, I can't make any comment on these movies.
...
```
They are not same movies as our previous data. IMDB use different terms to order Top 1000 List.
